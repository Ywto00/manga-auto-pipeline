 ...
 *
 * Depends on:
 *  - src/infra/config/config-store.js  (loadConfig)
 *  - src/infra/sync/anilist-adapter.js  (fetchAniListMediaById)  - soft dep
 *  - src/infra/metadata/metadata-index.js (buildListMetadataIndex, etc) - soft dep
 *
...
const fs = require('fs');
const { loadConfig, getDataPaths } = require('../config/config-store');
const { buildListMetadataIndex, buildListMetadataById, buildSeriesJsonMetadataIndex, mergeItemMetadata, findSeriesMetadata } = require('../metadata/metadata-index');
const { fetchAniListMediaById } = require('../sync/anilist-adapter');
